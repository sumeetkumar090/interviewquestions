...
public class JavaLinks extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		expListView.setOnChildClickListener(new OnChildClickListener() {
			...
			public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition,
				...
				Intent intent = new Intent(JavaLinks.this, myWebClient.class);
	...
	private void prepareListData() {
		...
		// Adding child data
		listDataHeader.add("Various Java Programs");
		listDataHeader.add("Useful Links");

		// Adding child data
		List<String> l1 = new ArrayList<String>();
		l1.add(" http://www.java2novice.com/java-interview-programs/");

		List<String> l2 = new ArrayList<String>();
		l2.add(" http://www.programmingsimplified.com/java-source-codes");
