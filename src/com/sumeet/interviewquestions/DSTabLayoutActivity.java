...
import com.sumeet.quiz.DataSQuizActivity;
...
public class DSTabLayoutActivity extends TabActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Intent photosIntent = new Intent(DSTabLayoutActivity.this, DataS.class);
        ...
        Intent songsIntent = new Intent(DSTabLayoutActivity.this, DataStructurePrograms.class);
        ...
        Intent videosIntent = new Intent(DSTabLayoutActivity.this, DataStructureLinks.class);
        ...
        Intent Quiz = new Intent(DSTabLayoutActivity.this, DataSQuizActivity.class);
