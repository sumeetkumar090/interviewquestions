...
//						Toast.LENGTH_SHORT).show();
		...
		expListView.setOnChildClickListener(new OnChildClickListener() {
			...
			public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition,
				...
				Toast.makeText(getApplicationContext(),
				 ...
				 Intent intent = new Intent(AndroidLinks.this, myWebClient.class);
	...
	private void prepareListData() {
		...
		// Adding child data
		listDataHeader.add("Android Basics");
		listDataHeader.add("Begineer Android");
		listDataHeader.add("Useful Links");
		 
		// Adding child data 1
		List<String> comingSoon1 = new ArrayList<String>();
		comingSoon1.add("http://www.tutorialspoint.com/android/android_custom_fonts.htm");
		List<String> comingSoon2 = new ArrayList<String>();
		List<String> comingSoon3 = new ArrayList<String>();
		comingSoon2.add("http://www.mkyong.com/tutorials/android-tutorial/");
		comingSoon3.add("http://andytsui.wordpress.com/");
