...
public class CTabLayoutActivity extends TabActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Intent photosIntent = new Intent(CTabLayoutActivity.this, CLang.class);
        ...
        Intent songsIntent = new Intent(CTabLayoutActivity.this, CPrograms.class);
        ...
        Intent videosIntent = new Intent(CTabLayoutActivity.this, CLinks.class);
     ...
     // Tab4
        ...
        Intent quiz = new Intent(CTabLayoutActivity.this,  CQuizActivity.class);
        ...
        tabHost.addTab(tab4);//  Adding tab4
    }
}