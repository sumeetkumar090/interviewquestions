...
public class DataSQuizActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		DataSDbHelper db = new DataSDbHelper(this);
			...
			public void onClick(View v) {
				...
				if (grp.getCheckedRadioButtonId() == -1) {
					...
					if (qid < 5) {
						...
						Intent intent = new Intent(DataSQuizActivity.this, ResultActivity.class);
						Bundle b = new Bundle();
